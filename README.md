...
`2.0.0-beta.18` product train. Core features include workflows, activities,
...
```bash
pip install durable-workflow==2.0.0-beta.18
```
...
SDK version `2.0.0-beta.18` is supported with server `2.0.0-beta.18`. The server
