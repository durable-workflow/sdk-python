...
`2.0.0-beta.10` product train. Core features include workflows, activities,
...
```bash
pip install durable-workflow==2.0.0-beta.10
```
...
SDK version `2.0.0-beta.10` is supported with server `2.0.0-beta.10`. The server
