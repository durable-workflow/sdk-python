...
`2.0.0-rc.6` product train. Core features include workflows, activities,
...
```bash
pip install durable-workflow==2.0.0-rc.6
```
...
SDK version `2.0.0-rc.6` is supported with server `2.0.0-rc.6`. The server
