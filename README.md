...
`2.0.0-beta.16` product train. Core features include workflows, activities,
...
```bash
pip install durable-workflow==2.0.0-beta.16
```
...
SDK version `2.0.0-beta.16` is supported with server `2.0.0-beta.16`. The server
