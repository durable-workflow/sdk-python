...
`2.0.0-rc.4` product train. Core features include workflows, activities,
...
```bash
pip install durable-workflow==2.0.0-rc.4
```
...
SDK version `2.0.0-rc.4` is supported with server `2.0.0-rc.4`. The server
