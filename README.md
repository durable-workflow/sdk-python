...
`2.0.0-beta.17` product train. Core features include workflows, activities,
...
```bash
pip install durable-workflow==2.0.0-beta.17
```
...
SDK version `2.0.0-beta.17` is supported with server `2.0.0-beta.17`. The server
