...
`2.0.0-rc.5` product train. Core features include workflows, activities,
...
```bash
pip install durable-workflow==2.0.0-rc.5
```
...
SDK version `2.0.0-rc.5` is supported with server `2.0.0-rc.5`. The server
