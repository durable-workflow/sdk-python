...
`2.0.0-beta.21` product train. Core features include workflows, activities,
...
```bash
pip install durable-workflow==2.0.0-beta.21
```
...
SDK version `2.0.0-beta.21` is supported with server `2.0.0-beta.21`. The server
