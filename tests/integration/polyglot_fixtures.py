...
PHP_HISTORY_EVENT_FIXTURES = [
    ...
    },
    {
        ...
        "payload": {
            ...
            "sequence": 1,
            "attempt_number": 1,
            "result": serializer.encode({"activity": "ok"}, codec="avro"),
            "payload_codec": "avro",
    ...
    },
    {
        ...
        "payload": {
            ...
            "arguments": serializer.encode(["alice"], codec="avro"),
            "payload_codec": "avro",
        },
    },
    {
        ...
        "payload": {
            ...
            "workflow_run_id": "run-polyglot-1",
            "update_name": "rename",
            "arguments": serializer.encode(["new-name"], codec="avro"),
            "sequence": 3,
            "payload_codec": "avro",
        },
    },
    ...
    },
    {
        ...
        "payload": {
            "sequence": 5,
            "result": serializer.encode({"side_effect": "stable"}, codec="avro"),
            "payload_codec": "avro",
        },
    },
    {
    ...
    },
    {
        ...
        "payload": {
            ...
            "output": serializer.encode({"child": "ok"}, codec="avro"),
            "parallel_group_id": None,
            "parallel_group_kind": None,
            "parallel_group_base_sequence": None,
            "parallel_group_size": None,
            "parallel_group_index": None,
            "parallel_group_path": None,
            "result": serializer.encode({"child": "ok"}, codec="avro"),
            "payload_codec": "avro",
        },
    },
    {
